...
> [!NOTE]
> 推荐从 [Releases](https://github.com/WINDGAND/Bailin/releases/latest) 下载最新 **Bailin-Setup-x.y.z.exe**（当前为 `0.0.15`，Windows x64）。亦可按下方步骤源码构建。
...
- **意见反馈可选** — 设置里「意见反馈」由你主动提交；只会发送你填写的文字、可选图片、当前版本号和可选联系方式。默认仍不上报遥测
...
| 阶段 | 主题 | 代表能力 |
| --- | --- | --- |
| **v0.x**（现在 · `0.0.15`） | MVP 闭环 | 深度造人、桌宠、本地记忆、更新日志 / 版本检查、Windows、自带 Key |
