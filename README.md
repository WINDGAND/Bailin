...
> [!NOTE]
> 推荐从 [Releases](https://github.com/WINDGAND/Bailin/releases/latest) 下载最新 **Bailin-Setup-x.y.z.exe**（当前为 `0.0.13`，Windows x64）。亦可按下方步骤源码构建。
...
| 阶段 | 主题 | 代表能力 |
| --- | --- | --- |
| **v0.x**（现在 · `0.0.13`） | MVP 闭环 | 深度造人、桌宠、本地记忆、更新日志 / 版本检查、Windows、自带 Key |
