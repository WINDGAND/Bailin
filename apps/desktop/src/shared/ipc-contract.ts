...
/**
 * 渲染进程与主进程之间的 IPC 契约。
 * Preload 暴露给渲染进程一个 `window.bailin` 对象，下方所有方法都通过 ipcRenderer.invoke。
 */
...
/** 渲染进程接收到的深度蒸馏事件（与 BailinOrchestrator.DeepProgressEvent 对齐，但去掉了 bundle 类型）。 */
...
/** Phase 1.5 结构化调研 Review（对齐百灵 merge_research.py）。 */
...
export const IPC = {
  AppIsFirstRun: "bailin.app.isFirstRun",
  AppCompleteFirstRun: "bailin.app.completeFirstRun",
  AppQuit: "bailin.app.quit",
  AppGetLocale: "bailin.app.getLocale",
  AppSetLocale: "bailin.app.setLocale",
  ...
  LlmTestConnection: "bailin.llm.testConnection",
  LlmClearKey: "bailin.llm.clearKey",

  ImageGenGetConfig: "bailin.imageGen.getConfig",
  ImageGenSetConfig: "bailin.imageGen.setConfig",
  ImageGenDetectCapability: "bailin.imageGen.detectCapability",
  ImageGenTest: "bailin.imageGen.test",
  ...
  CharactersGetActive: "bailin.characters.getActive",
  CharactersListStarters: "bailin.characters.listStarters",
  CharactersDetectCapabilities: "bailin.characters.detectCapabilities",
  CharactersDetectVision: "bailin.characters.detectVision",
  CharactersProbeVision: "bailin.characters.probeVision",
  CharactersProbeWebSearch: "bailin.characters.probeWebSearch",

  ChatSend: "bailin.chat.send",
  ChatCancel: "bailin.chat.cancel",
  ChatNewSession: "bailin.chat.newSession",
  ChatGetActiveSession: "bailin.chat.getActiveSession",
  ChatGetRecent: "bailin.chat.getRecent",
  ChatListSessions: "bailin.chat.listSessions",
  ChatSwitchSession: "bailin.chat.switchSession",
  ChatRenameSession: "bailin.chat.renameSession",
  ChatDeleteSession: "bailin.chat.deleteSession",
  ChatHide: "bailin.chat.hide",
  ChatIsVisible: "bailin.chat.isVisible",
  ChatGetSize: "bailin.chat.getSize",
  ChatResize: "bailin.chat.resize",
  ChatDeleteTurn: "bailin.chat.deleteTurn",
  ChatDeleteTurnsFrom: "bailin.chat.deleteTurnsFrom",

  MemoryGetProfile: "bailin.memory.getProfile",
  MemoryUpdateProfile: "bailin.memory.updateProfile",
  MemoryClearProfile: "bailin.memory.clearProfile",
  MemoryGetPerCharacter: "bailin.memory.getPerCharacter",
  MemoryClearPerCharacter: "bailin.memory.clearPerCharacter",
  MemoryClearAll: "bailin.memory.clearAll",
  MemoryGetSettings: "bailin.memory.getSettings",
  MemorySetSettings: "bailin.memory.setSettings",
  MemoryGetRecentChanges: "bailin.memory.getRecentChanges",
  MemoryUndoLastChange: "bailin.memory.undoLastChange",

  PetSummon: "bailin.pet.summon",
  PetHush: "bailin.pet.hush",
  PetSetPosition: "bailin.pet.setPosition",
  PetSetMouseIgnore: "bailin.pet.setMouseIgnore",
  ...
  ProactiveBubbleDismiss: "bailin.proactiveBubble.dismiss",
  ProactiveBubbleResize: "bailin.proactiveBubble.resize",

  ProactiveGetSettings: "bailin.proactive.getSettings",
  ProactiveSetSettings: "bailin.proactive.setSettings",
  ProactiveGetStatus: "bailin.proactive.getStatus",
  ProactiveTriggerNow: "bailin.proactive.triggerNow",
  ProactiveTriggerLlmScreenshot: "bailin.proactive.triggerLlmScreenshot",
  ProactiveFocusMode: "bailin.proactive.focusMode",

  EventChatStream: "bailin.event.chatStream",
  ...
  EventDistillationProgress: "bailin.event.distillationProgress",
  EventLocaleChanged: "bailin.event.localeChanged",
