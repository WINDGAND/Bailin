...
> [!NOTE]
> Download the latest **Bailin-Setup-x.y.z.exe** from [Releases](https://github.com/WINDGAND/Bailin/releases/latest) (currently `0.0.11`, Windows x64), or build from source below.
...
| --- | --- | --- |
| **v0.x** (now · `0.0.11`) | MVP loop | Deep create, desktop pet, local memory, changelog / update check, Windows, BYO key |
...
Early **v0.0.x** (currently `0.0.11`) — contributions welcome:
